...
export type ChatMessageWhereInput = {
  ...
  msgId?: Prisma.StringFilter<"ChatMessage"> | string
...
export type ChatMessageScalarWhereWithAggregatesInput = {
  ...
  msgId?: Prisma.StringWithAggregatesFilter<"ChatMessage"> | string
...
export type ChatMessageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"msgId" | "chatId" | "role" | "content" | "createTime", ExtArgs["result"]["chatMessage"]>
...
export interface ChatMessageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const chatMessageWithMsgIdOnly = await prisma.chatMessage.findMany({ select: { msgId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ChatMessages and only return the `msgId`
   * const chatMessageWithMsgIdOnly = await prisma.chatMessage.createManyAndReturn({
   *   select: { msgId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ChatMessages and only return the `msgId`
   * const chatMessageWithMsgIdOnly = await prisma.chatMessage.updateManyAndReturn({
   *   select: { msgId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ChatMessageFieldRefs {
  readonly msgId: Prisma.FieldRef<"ChatMessage", 'String'>
